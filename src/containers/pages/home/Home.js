                                                    ...
                                                    {/*  */}
                                                     ...
                                                     <div className="form-row">
                                                        ...
                                                        <div className="form-group col-md-6">
                                                            <FileUpload
                                                                onChange={(e) => {
                                                                    handleFileChange('screenShots', e, setFieldValue);
                                                                }}
                                                                name="screenShots"
                                                                value={values.screenShots && `${values.screenShots.name} / ${values.screenShots.size / 1000} kb` || ""}
                                                        ...
                                                        <div className="form-group col-md-6">
                                                            <FileUpload
                                                                onChange={(e) => {
                                                                    handleFileChange('supportingDocs', e, setFieldValue);
                                                                }}
                                                                name="supportingDocs"
                                                                value={values.supportingDocs && `${values.supportingDocs.name} / ${values.supportingDocs.size / 1000} kb` || ""}
